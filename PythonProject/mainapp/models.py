...
class Product(models.Model):
    ...
    #     image = self.image ЭТО ВТОРОЙ СПОСОБ ОПТИМИЗАЦИИ САЙТА
    #     img = Image.open(image)
    #     new_img = img.convert('RGB')
    #     resized_new_img = new_img.resize((600, 500), Image.ANTIALIAS)
    #     filestream = BytesIO()
...
class Smartphone(Product):
    ...
    sd_volume_max = models.CharField(max_length=255, verbose_name='Максимальный объем встраимаемой памяти')
